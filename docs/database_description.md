...
## Призначення
SQLite база даних демонструє структуру даних дипломного прототипу та використовується для зберігання імпортованих продажів, товарів, прогнозів, метрик і журналу імпортів.
...
Призначення: допоміжна таблиця для сценаріїв подальшого розвитку системи.
